...
<head>
    ...
    <title>Change Password | Sistem Sertifikat Webminar</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Ganti Password</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post" onsubmit="return checkpass();" name="changepassword" method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Kata Sandi Saat Ini:</label>
                                                                </div>
                                                                <div class="col-lg-9">
