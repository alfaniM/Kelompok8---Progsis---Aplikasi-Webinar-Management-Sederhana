                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: red">Form Login</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="mobno" maxlength="13" pattern="[0-9]+" required="true" />
...
<p style="text-align: center;"><a href="../index.php">Kembali Ke Menu Utama!!!</a></p>
                                    </div>
                                </div>
                            </div>
                        </form>
