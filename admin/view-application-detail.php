...
<head>
    ...
    <title>Kelola Formulir Aplikasi | Sistem Sertifikat Webminar</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Formulir Aplikasi</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Lihat <span class="table-project-n"> Detail</span> Aplikasi</h1>
...
Detail Pengguna</td></tr>
<tr align="center">
<td colspan="4" style="font-size:20px;color:red">
Nomor Aplikasi:  <?php  echo $row->ApplicationID;?></td></tr>
    <tr>
    <th scope>Nama Depan</th>
    <td><?php  echo $row->FirstName;?></td>
    <th scope>Nama Belakang</th>
