                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                            <marquee behavior="alternate" onmouseout="this.start()" onmouseover="this.stop()"> <h3>Webminar</h3> </marquee>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: red">Form Login Admin </h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="login-keep-me">
                                                        <label class="checkbox">
                                                            <input type="checkbox" name="remember" id="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?>><i></i>Buat Saya Tetap Masuk
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-button-pro">
                                                ...
                                                <button type="submit" class="login-button login-button-lg" name="login">Masuk</button>
