                            ...
                            <div class="col-lg-6 col-md-1 col-sm-1 col-xs-12">
                                <div class="header-top-menu tabl-d-n">
                                    <ul class="nav navbar-nav mai-top-nav">
                                        ...
                                        <li class="nav-item"><a href="all-birth-application.php" class="nav-link">Semua Aplikasi</a>
                                        </li>
                                        <li class="nav-item"><a href="between-dates-report.php" class="nav-link">Report</a>
                                        </li>
                                       
                                        <li class="nav-item"><a href="search.php" class="nav-link">Cari</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <li class="nav-item"><a href="new-birth-application.php" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-bell-o" aria-hidden="true"></i><span class="indicator-nt"></span></a>
                                            <div role="menu" class="notification-author dropdown-menu animated flipInX">
                                                <div class="notification-single-top">
                                                    <h1>Pemberitahuan<?php echo htmlentities($totneworder);?></h1>
                                                </div>
...
{ 
  ...
  ?>
                                                ...
                                                <div class="notification-view">
                                                    <a href="all-birth-application.php">Lihat Semua Pemberitahuan</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="nav-item">
...
{               ?>
                                        <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                                ...
                                                <li><a href="profile.php"><span class="adminpro-icon adminpro-user-rounded author-log-ic"></span>Profil saya</a>
                                                </li>
                                                 <li><a href="change-password.php"><span class="adminpro-icon adminpro-settings author-log-ic"></span>Pengaturan</a>
                                                </li>
                                                <li><a href="logout.php"><span class="adminpro-icon adminpro-locked author-log-ic"></span>Keluar</a>
                                                </li>
                                            </ul>
                                        </li>
